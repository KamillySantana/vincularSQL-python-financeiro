...
def index():
    ...
    return render_template('home.html', total_receitas=total_receitas, total_despesas=total_despesas, total_guardar=total_guardar, rece=receitas, despe=despesas, guar=guardar, usuario=usuario)
